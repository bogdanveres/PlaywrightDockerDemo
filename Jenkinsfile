      ...
      parallel {
        stage('Chrome') {
          steps {
            ...
            dotnetTest(configuration: 'Debug', project: 'PlaywrightSharp.csproj', sdk: 'Net5Master', workDirectory: 'PlaywrightSharp', runtime: '5.0.13', specificSdkVersion: true, settings: 'Chrome.runsettings', logger: 'trx', noRestore: true)
          }
        }
